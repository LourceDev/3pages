...
apiRouter.put("/entry", passport.authenticate("jwt", { session: false }), async (req, res) => {
...
apiRouter.get("/entry/dates", passport.authenticate("jwt", { session: false }), async (req, res) => {
...
apiRouter.get("/entry/:date", passport.authenticate("jwt", { session: false }), async (req, res) => {
...
apiRouter.delete("/entry/:date", passport.authenticate("jwt", { session: false }), async (req, res) => {
